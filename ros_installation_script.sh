...
# The BSD License
# Modified 2024 to add instructions to install turtlebot3 and its simulation related packages
...
sudo apt-get update && sudo apt-get upgrade && sudo apt-get install -y lsb-release && sudo apt-get clean all
...
echo ""
echo "AMENT_TRACE_SETUP_FILES=1 source /opt/ros/${name_ros_distro}/setup.bash" >> /home/${user_name}/.ros2
echo "added to .ros2"
# source /home/${user_name}/.ros2
echo ""
echo "######################################### ##############################################################################"
